Public Class frmcliente2
    ...
    Private Sub btneliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btneliminar.Click
        ...
        result = MessageBox.Show("Realmente desea eliminar los trabajadores?", "Eliminando registros", MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
        If result = DialogResult.OK Then 'si hace click en ok entonces eliminamos
            Try
                ...
                For Each row As DataGridViewRow In datalistado.Rows
                    ...
                    If marcado Then
                        Dim oneKey As Integer = Convert.ToInt32(row.Cells("idcliente").Value) 'enviamos el campo de la llave principal para eliminarlo
                        ...
                        Else
                            ...
                            MessageBox.Show("Error al eliminar los trabajadores", "Eliminando registros", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        End If
                    End If
                Next
                'llamamos a mostrar
    ...
    Private Sub btneditar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btneditar.Click
        ...
        result = MessageBox.Show("Realmente desea modificar los datos del trabajador?", "MOdificando registros", MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
        If result = DialogResult.OK Then 'si esta seguro de modificar
            'verficamos que todos los campos no esten vacios
            If Me.ValidateChildren = True And txtcodigo.Text <> "" And txtnombres.Text <> "" And txtapellidos.Text <> "" And txtdni.Text <> "" And txttelefono.Text <> "" And txtdireccion.Text <> "" And cbosexo.Text <> "" And txtemail.Text <> "" And txtobservacion.Text <> "" Then
                Try
                    ...
                    Else
                        ...
                        MessageBox.Show("Error al intentar Modificar Cliente", "MOdificanco registros", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    End If
        ...
        Else
            ...
            MessageBox.Show("NO se ha modificado el Cliente", "MOdificando registros", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Call mostrar()
        End If
    ...
    Private Sub btnguardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnguardar.Click
        ...
        If Me.ValidateChildren = True And txtnombres.Text <> "" And txtapellidos.Text <> "" And txtdni.Text <> "" And txttelefono.Text <> "" And txtdireccion.Text <> "" And cbosexo.Text <> "" And txtemail.Text <> "" And txtobservacion.Text <> "" Then
            Try
                ...
                If func.insertar(dts) Then
                    MessageBox.Show("Cliente Guardado Correctamente", "Guardando registros", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    mostrar()
                    limpiar()
                Else
                    MessageBox.Show("Error al intentar Guardar Cliente", "Guardando registros", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    mostrar()
                    limpiar()
    ...
    Private Sub txtobservacion_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtobservacion.MouseHover
        'mostramos un mensaje informativo
        ttmensaje.SetToolTip(txtobservacion, "Ingrese una observación del Cliente, algunas referencias etc.")
        ttmensaje.ToolTipTitle = "Observación"
    ...
    Private Sub txtdireccion_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtdireccion.MouseHover
        'mostramos un mensaje informativo
        ttmensaje.SetToolTip(txtdireccion, "Ingrese la dirección del Cliente, calle y numero-distrito-provincicia-region")
    ...
    Private Sub Label1_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles Label1.MouseHover
        ...
        ttmensaje.ToolTipTitle = "Código Trabajador"
        ttmensaje.ToolTipIcon = ToolTipIcon.Info
    End Sub



    Private Sub txtobservacion_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtobservacion.Validating
        'mostramos el globo informativo de error
        If DirectCast(sender, TextBox).Text.Length > 0 Then
            Me.erroricono.SetError(sender, "")
        Else
            Me.erroricono.SetError(sender, "Ingrese una observación del Cliente, este dato es obligatorio")
    ...
    Private Sub frmcliente2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
